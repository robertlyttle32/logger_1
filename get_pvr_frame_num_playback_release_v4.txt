...
w_1_my_img2 = ImageTk.PhotoImage(Image.open('C:/Users/rlyttle/Desktop/RL Programs update june 2021/avc_pvr_audit update june 2021/logger_1/neology_logo.PNG'))
...
w_1_btn_showscreen_5_0.grid(row=5, column=0, sticky="wse", padx=5)
...
#Images
w_1_neology_logo.grid(row=0, column=0, sticky='we')
